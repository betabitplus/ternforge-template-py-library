...
grep -F 'ternforge-docops>=0.4.3,<0.5' "$product_target/pyproject.toml"
grep -F 'tag = "v0.4.3"' "$product_target/pyproject.toml"
...
assert "ternforge-docops>=0.4.3,<0.5" in pyproject["dependency-groups"]["docs"]
