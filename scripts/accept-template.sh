...
grep -F 'ternforge-docops>=0.13.0,<0.14' "$product_target/pyproject.toml"
grep -F 'tag = "v0.13.0"' "$product_target/pyproject.toml"
...
assert "ternforge-docops>=0.13.0,<0.14" in pyproject["dependency-groups"]["docs"]
...
PY
  ...
  test -f "$docs_html/verification-assurance.html"
  grep -F 'Verification assurance map' "$docs_html/verification-assurance.html"
  grep -F 'Current proof:' "$docs_html/verification-assurance.html"
  grep -F 'Implementation:' "$docs_html/verification-assurance.html"
  grep -F 'Verification:' "$docs_html/verification-assurance.html"
  grep -F 'Runtime assurance:' "$docs_html/verification-assurance.html"
  ...
  test ! -e "$product_target/docs/traceability.rst"
  test ! -e "$product_target/docs/verification-assurance.rst"
