...
grep -F 'ternforge-docops>=0.13.1,<0.14' "$product_target/pyproject.toml"
grep -F 'tag = "v0.13.1"' "$product_target/pyproject.toml"
...
assert "ternforge-docops>=0.13.1,<0.14" in pyproject["dependency-groups"]["docs"]
